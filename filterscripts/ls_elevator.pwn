...
public OnDynamicObjectMoved(objectid) {
    ...
    if(objectid == Obj_Elevator) // The elevator reached the specified floor.
    {
        ...
        Label_Elevator = CreateDynamic3DTextLabel("{CCCCCC}Press '{FFFFFF}~k~~CONVERSATION_YES~{CCCCCC}' to use elevator", 0xCCCCCCAA, 1784.9822, -1302.0426, z - 0.9, 4.0);
...
stock Elevator_Initialize() {
    ...
    Label_Elevator = CreateDynamic3DTextLabel("{CCCCCC}Press '{FFFFFF}~k~~CONVERSATION_YES~{CCCCCC}' to use elevator", 0xCCCCCCAA, 1784.9822, -1302.0426, 13.6491, 4.0);
